        ...
        <div className="container mx-auto relative z-10 px-4 flex-1 flex flex-col justify-center">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 w-full">
            <div className="w-full max-w-4xl text-left flex flex-col items-start">
              ...
              <div className="text-sm sm:text-base md:text-lg mb-8 max-w-2xl text-white/80 mx-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10 justify-start w-full sm:w-auto">
